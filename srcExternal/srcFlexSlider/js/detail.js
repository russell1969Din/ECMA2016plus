 $(document).ready(function() {
 	var zaujemOInformacie = 'MĂˇm zĂˇujem o ÄŹalĹˇie informĂˇcie. ';
 	var zaujemOObhliadku = 'MĂˇm zĂˇujem o obhliadku nehnuteÄľnosti. ';
...
function mapDialog(gpsX,gpsY,address) {
	var kdeSaNachadza = 'Kde sa nehnuteÄľnosĹĄ nachĂˇdza?';
...
function mamZaujemForm() {
	...
	var zadajteSpravnyEmail = "zadajte sprĂˇvny e-mail";
